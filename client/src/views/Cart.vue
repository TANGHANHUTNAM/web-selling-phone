              ...
              <div class="card shadow-0 border">
                <div class="card-body">
                  <div class="d-flex justify-content-between">
                    <p class="mb-2">Tổng:</p>
                    <p class="mb-2">{{ formatPrice(totalPrice) }}đ</p>
                  </div>
                  <div class="d-flex justify-content-between">
                  ...
                  <div class="d-flex justify-content-between">
                    ...
                    <p class="mb-2 fw-bold">{{  formatPrice(totalPrice) }}đ</p>
                  </div>
...
export default {
  ...
  setup() {
    ...
    const getCartItems = async () => {
      const response = await axios.get("http://localhost:8081/api/shoppingcart/662cab1334798f0519e912d0/shoppingcartitem");
    ...
    return {
      totalPrice, cartItems, formatPrice
    };
  },
};
</script>
